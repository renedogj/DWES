<html>
   ...
   <head>
    ...
    <div class="container ">
		...
		<input type="button" value="Alquilar Películas" onclick="window.location.href='alqpel.php'" class="btn btn-warning disabled">
		
		<input type="button" value="Consultar Alquileres" onclick="window.location.href='alqcons.php'" class="btn btn-warning disabled">
		
		<input type="button" value="Devolver Películas" onclick="window.location.href='alqdev.php'" class="btn btn-warning disabled"><BR>
